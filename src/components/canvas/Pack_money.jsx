...
const Packmoney = () => {
  ...
  return (
    <primitive object={packmoney.scene} scale={2} position-y={0} rotation-y={0} />
  );
};
  ...
  return (
    <Canvas
      ...
      camera={{
        ...
        position: [-4, 5, 6], // カメラの初期位置を設定（x, y, z）
      }}
    >
      <Suspense fallback={<CanvasLoader />}>
        ...
        <OrbitControls
          ...
          // maxPolarAngle={Math.PI / 0.65} // カメラの最大ポーラー角度を設定（カメラの上下移動範囲を制限）
          // minPolarAngle={Math.PI / 0.15} // カメラの最小ポーラー角度を設定（カメラの上下移動範囲を制限）
        />
